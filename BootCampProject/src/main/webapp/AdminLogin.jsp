<%@page import="com.ibtech.sales.inventory.entity.AdminUser"%>
<%@page import="com.ibtech.sales.inventory.manager.AdminUserManager"%>
...
<%
	...
	if(request.getParameter("login") != null){
		...
		if(username == ""){
			...
			AdminUser adminUser = adminUserManager.findByUserNamePassword(username, password);
			
			if(adminUser != null){
				session.setAttribute("auth", adminUser.getUserName());
